...
export function EmployeePayroll() {
    ...
    useEffect(() => {
        payrollService.getMyPayslips().then(setPayslips).catch(() => setError('Unable to load payroll records.')).finally(() => setLoading(false))
    }, [])
